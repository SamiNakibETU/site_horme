...
export const defaultHomePage: HomePageCms = {
  ...
  slides: [
    { url: '/assets/images/khormos/arthur-01.jpg', alt: 'Khormo(s) — les danseuses en mouvement sur scène', objectFit: 'cover', objectPosition: 'center 20%' },
    { url: '/assets/images/scene-ecriture/01.png', alt: 'Scène à l’écriture — répétition en atelier', objectFit: 'contain', objectPosition: 'center' },
    { url: '/assets/images/jardiniers/01.jpg', alt: 'Les Jardiniers — performance en extérieur à Montrouge', objectFit: 'cover', objectPosition: 'center' },
    { url: '/assets/images/khormos/arthur-02.jpg', alt: 'Khormo(s) — portée collective sous les projecteurs', objectFit: 'cover', objectPosition: 'center' },
    { url: '/assets/images/scene-ecriture/03.png', alt: 'Scène à l’écriture — travail au sol', objectFit: 'contain', objectPosition: 'center' },
    { url: '/assets/images/khormos/yse-02.jpg', alt: 'Khormo(s) — le groupe en formation rapprochée', objectFit: 'cover', objectPosition: 'center top' },
  ],
